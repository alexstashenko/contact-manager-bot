...
🔍 **Поиск и статистика:**
`/find` - Поиск по имени, компании или тегу
...
**Быстрое добавление:**
`/quick Иван Петров, TechCorp, HR, @ivan`
...
**Заметка:**
`/note @ivan Встретились на конференции`

**Поиск:**
`/find TechCorp`

**ИИ-запросы:**
Просто пишите вопросы боту:
• "Кто из HR?"
• "С кем давно не общался?"
• "Кто покупал в прошлом месяце?"
"""
